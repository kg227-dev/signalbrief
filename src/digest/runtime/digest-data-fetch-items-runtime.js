...
function createConversionFunnel() {
  return {
    ...
    search_evidence_resolver_attempt_count: 0,
    search_evidence_resolver_success_count: 0,
    search_evidence_resolver_fetch_failure_count: 0,
    search_evidence_resolver_parse_failure_count: 0,
    search_evidence_resolver_non_article_drop_count: 0,
    search_evidence_resolver_stale_count: 0,
    ...
    samples: {
      ...
      search_evidence_resolver_failures: [],
...
function mergeConversionFunnel(target, extra) {
  ...
  for (const key of [
    ...
    "search_evidence_resolver_attempt_count",
    "search_evidence_resolver_success_count",
    "search_evidence_resolver_fetch_failure_count",
    "search_evidence_resolver_parse_failure_count",
    "search_evidence_resolver_non_article_drop_count",
    "search_evidence_resolver_stale_count",
