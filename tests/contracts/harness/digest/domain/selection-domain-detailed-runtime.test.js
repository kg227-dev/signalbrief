...
const items = [
  ...
  { headline: "Beta", url: "https://news.example.com/b", tag: "TECHNOLOGY", source_domain: "reuters.com" },
  { headline: "Gamma", url: "https://news.example.com/c", tag: "AI", source_domain: "wsj.com" },
  { headline: "Delta", url: "https://news.example.com/d", tag: "CONSUMER & RETAIL", source_domain: "ft.com" },
  { headline: "Epsilon", url: "https://news.example.com/e", tag: "INDUSTRIALS", source_domain: "axios.com" },
...
assert.ok(result.selected.some((item) => item.headline === "Epsilon"));
assert.ok(result.selected.some((item) => item.headline === "Alpha"));
assert.ok(result.selected.every((item) => item.tag !== "custom_one" && item.tag !== "custom_two"));
