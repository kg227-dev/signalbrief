...
const requiredPageSnippets = [
  "Source Governance",
  "Inspect or edit a source",
  "Advanced diagnostics",
  "Older cleanup notes",
  "Recent source flags",
  "Good Vs Risky",
  "\"not in live broker roster\" does not automatically mean bad",
  "Why surfaced",
  "Rolling last 7 days sent sources",
  "All tracked history",
  "Validation Week 1 sent sources",
  "Loading sent-source window",
  "Loading broker roster",
  "Loading live config status",
  ...
  "function renderSentSourcesHeader(overview)",
  "function renderValidationReviewSummary(overview)",
  ...
  "Advanced controls",
  "More details",
  "function changeSourceRegistryHistoryMode()",
