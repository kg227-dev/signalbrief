...
withEnv({
  ...
  assert.strictEqual(policy.isAdminAuthed(retrievalHtmlReq), false, "local bypass should not allow retired retrieval eval html route");
  assert.strictEqual(policy.isAdminAuthed(retrievalApiReq), false, "local bypass should not allow retired retrieval eval api route");
