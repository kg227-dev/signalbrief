...
| `services/shared/index.js` | Canonical barrel for shared (non-user-specific) services: `archive-scoring`, `delivery-schedule`, `request-metadata`, `web-rate-limit`. | Named exports of shared service modules | `../archive-scoring`, `../delivery-schedule`, `../request-metadata`, `../web-rate-limit` |
